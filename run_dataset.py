...
img = cv2.imread('D:\Autopilot-TensorFlow-master\steering_wheel_image.jpg',0)
rows,cols = img.shape
...
while(cv2.waitKey(10) != ord('q')):
    full_image = scipy.misc.imread("D:\Autopilot-TensorFlow-master\driving_dataset\\" + str(i) + ".jpg", mode="RGB")
